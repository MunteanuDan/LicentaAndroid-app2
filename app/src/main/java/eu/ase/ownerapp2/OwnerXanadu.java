...
public class OwnerXanadu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_owner_xanadu);
        ...
        referenceComenziMasa1SumaXanadu.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        ...
        referenceComenziMasa2SumaXanadu.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
        ...
        referenceComenziMasa3SumaXanadu.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
    ...
    public void btnMasa1Finalizare(View v) {
        AlertDialog.Builder build = new AlertDialog.Builder(OwnerXanadu.this)
    ...
    private DialogInterface.OnClickListener getSaveComandaMasa1ClickEventPositiveEvent() {
        return new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                referenceComenziMasa1Xanadu.setValue("false");
            }
        };
    }
    ...
    private DialogInterface.OnClickListener getSaveComandaMasa2ClickEventPositiveEvent() {
        return new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                referenceComenziMasa2Xanadu.setValue("false");
            }
        };
    }
    ...
    private DialogInterface.OnClickListener getSaveComandaMasa3ClickEventPositiveEvent() {
        return new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                referenceComenziMasa3Xanadu.setValue("false");
            }
        };
    }
